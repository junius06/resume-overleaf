...
\begin{experiences}
  \experience
    ...
    {2025.04-Present} {
                    ...
                    {AWS, Kubernetes, CICD, Monitoring, Python, Shell Script, IaC}
  \emptySeparator
  \experience
    ...
    {2023.04-2025.01} {
                      \begin{itemize}
                        ...
                        \item 모니터링 및 보안 도구(Grafana, Prometheus, Vault) 운영
                      \end{itemize}
                    }
                    {AWS, Azure, Kubernetes, CICD, Monitoring, Python, Shell Script, IaC}
  \emptySeparator
  \experience
    ...
    {2020.03-2022.06}    {
                    ...
                    {CentOS, Network, Veritas NetBackup, Anti-Spam Solution(WBlock)}
  \emptySeparator
\end{experiences}
